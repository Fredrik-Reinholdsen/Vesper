...
const MODIFIER_LEFT_CTRL: u8 = 0x1;
const MODIFIER_LEFT_SHIFT: u8 = 0x2;
const MODIFIER_LEFT_ALT: u8 = 0x4;
const MODIFIER_LEFT_GUI: u8 = 0x8;
...
impl KeyPress {
    pub fn modifier_flags(&self) -> u8 {
        match self {
            KeyPress::LeftControl => 0x1,
            KeyPress::LeftShift => 0x2,
            KeyPress::LeftAlt => 0x4,
            KeyPress::LeftGUI => 0x8,
            KeyPress::RightControl => 0x10,
            KeyPress::RightShift => 0x20,
            KeyPress::RightAlt => 0x40,
            KeyPress::RightGUI => 0x80,
            _ => 0x0,
        }
    }
}
